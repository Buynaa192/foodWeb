...
// "use client";
// import { foodType } from "@/components/Appetizers";
// import {
//   Dialog,
//   DialogContent,
//   DialogHeader,
...
//     try {
//       setLoading(true);
//       const res = await axios.post<FoodType>(
//         "http://localhost:3001/food/post",
//         {
//           foodName: foodName,
//           price: price,
//           ingredients: orts,
...
//         <div
//           onClick={() => setOpen(true)}
//           className="w-[270px] h-[241px] border-1 border-dashed border-red-500 rounded-[20px] flex flex-col gap-6 justify-center items-center"
//         >
//           <p className="h-9 w-9 bg-red-500 rounded-full flex items-center justify-center text-white">
//             +
//           </p>
...
//           <DialogTitle>Add new Dish to {categoryName}</DialogTitle>
//         </DialogHeader>
//         <div className="w-100 h-110 mt-6 flex flex-col gap-6">
//           <div className=" w-full h-15 flex gap-6">
//             <div className="w-full ">
//               <p className="text-[14px] font-medium">Food name</p>
//               <input
//                 placeholder="Type food name"
...
//               placeholder="List ingredients..."
//               onChange={(e) => {
//                 setOrts(e.target.value);
//               }}
//               className="pb-12 border-1 border-[#E4E4E7] rounded-md"
//             ></input>
//           </div>
...
//               alt="Preview"
//               type="file"
//               className="pb-25 border-1 border-dashed border-[##2563EB33] bg-[#2563EB33] rounded-md"
//             ></input>
//           </div>
...
//               disabled={loading}
//               onClick={addFood}
//               className="rounded-md h-10 w-23 text-white bg-black flex justify-center items-center"
//             >
//               {loading ? (
//                 <Loader size={16} className="animate-spin" />
//               ) : (
